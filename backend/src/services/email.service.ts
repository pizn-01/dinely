...
class EmailService {
  ...
  async sendReservationConfirmation(params: {
    ...
    return this.send({
      ...
      html: `
        ...
        <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: ${params.brandingColor && params.brandingColor.trim() !== '' ? params.brandingColor : '#0B1517'}; color: #ffffff; padding: 40px; border-radius: 16px;">

          <div style="text-align: center; margin-bottom: 32px;">

            ${params.logoUrl ? 

              `<img src="${params.logoUrl}" alt="${params.restaurantName}" style="max-width: 120px; max-height: 64px; object-fit: contain; margin-bottom: 16px;" />` :
              ...
              `<div style="width: 64px; height: 64px; background: rgba(74, 158, 107, 0.15); border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 16px;">
                ...
                <span style="font-size: 28px; color: #4a9e6b;">✓</span>

              </div>`

            }

            <h1 style="font-size: 24px; font-weight: 700; margin: 0 0 8px 0; color: #ffffff;">Reservation Confirmed!</h1>
          ...
          <div style="background-color: #101A1C; border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
            ...
            <p style="margin: 0 0 8px 0; color: #e6edf3;">Hi ${params.guestName},</p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
              ...
              <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-weight: 600; text-align: right; color: #ffffff;">${params.date}</td>
              ...
              <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-weight: 600; text-align: right; color: #ffffff;">${params.time}</td>
              ...
              <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-weight: 600; text-align: right; color: #ffffff;">${params.partySize} guests</td>
              ...
              <tr>
                ...
                <td style="padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-weight: 600; text-align: right; color: #ffffff;">${params.tableName}</td>
          ...
          <div style="background-color: rgba(201, 156, 99, 0.1); border: 1px solid rgba(201, 156, 99, 0.25); border-radius: 12px; padding: 20px; margin-bottom: 24px;">
            ...
            <p style="margin: 0; font-size: 14px; color: #C99C63; font-weight: 600;">⚠️ ${params.cancellationPolicy ? 'Cancellation Policy' : 'Important Notice'}</p>

            <p style="margin: 8px 0 0 0; font-size: 13px; color: #c9d1d9; line-height: 1.5;">

              ${params.cancellationPolicy || `Your reservation will be held for <strong style="color: #ffffff;">15 minutes</strong> past your scheduled time. After that, it may be released to other guests. Please be on time!`}
          ...
          <div style="background-color: rgba(201, 156, 99, 0.1); border: 1px solid rgba(201, 156, 99, 0.25); border-radius: 12px; padding: 20px; margin-bottom: 24px;">
            ...
            <p style="margin: 0; font-size: 14px; color: #C99C63; font-weight: 600;">📝 Special Note</p>
          ...
          <!-- Cancellation Button Only -->

          ${params.cancellationUrl ? `

          <div style="text-align: center; margin-bottom: 24px;">

            <a href="${params.cancellationUrl}" style="display: inline-block; padding: 14px 28px; background: #E05D5D; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px; box-shadow: 0 2px 8px rgba(224, 93, 93, 0.3); transition: all 0.2s ease;">
      ...
      text: `Hi ${params.guestName}, your reservation at ${params.restaurantName} is confirmed for ${params.date} at ${params.time} (${params.partySize} guests). Confirmation #${params.confirmationId.substring(0, 8).toUpperCase()}. ${params.cancellationPolicy ? `Cancellation Policy: ${params.cancellationPolicy}` : 'Please note: Your reservation will be held for 15 minutes past your scheduled time. After that, it may be released.'}${params.restaurantPhone ? ` Contact: ${params.restaurantPhone}` : ''}`,
      ...
      html: `
        ...
        <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #0B1517; color: #ffffff; padding: 40px; border-radius: 16px;">
          ...
          <div style="text-align: center; margin-bottom: 32px;">
            ...
            <h1 style="font-size: 24px; font-weight: 700; margin: 0 0 8px 0; color: #ffffff;">Reservation Cancelled</h1>
          ...
          <div style="background-color: #101A1C; border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
            ...
            <p style="margin: 0 0 12px 0; color: #e6edf3;">Hi ${params.guestName},</p>
   ...
   * Send admin notification for reservation changes.

   */

  async sendReservationChangeNotification(params: {
    ...
    const isCancellation = params.changeType === 'cancelled';

    const subject = isCancellation 

      ? `Reservation Cancelled — ${params.restaurantName}` 

      : `Reservation Modified — ${params.restaurantName}`;
    ...
    return this.send({
      ...
      html: `
        ...
        <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #0B1517; color: #ffffff; padding: 40px; border-radius: 16px;">
          ...
          <div style="text-align: center; margin-bottom: 32px;">
            ...
            <div style="width: 64px; height: 64px; background: ${isCancellation ? 'rgba(224, 93, 93, 0.15)' : 'rgba(201, 156, 99, 0.15)'}; border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; margin-bottom: 16px;">

              <span style="font-size: 28px; color: ${isCancellation ? '#E05D5D' : '#C99C63'};">${isCancellation ? '✕' : '✏'}</span>

            </div>

            <h1 style="font-size: 24px; font-weight: 700; margin: 0 0 8px 0; color: #ffffff;">Reservation ${isCancellation ? 'Cancelled' : 'Modified'}</h1>

            <p style="color: #8b949e; margin: 0; font-size: 14px;">${params.restaurantName} - Admin Notification</p>
          ...
          <div style="background-color: #101A1C; border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
            ...
            <p style="margin: 0 0 12px 0; color: #e6edf3;">Hi ${params.adminName},</p>

            <p style="margin: 0 0 16px 0; color: #c9d1d9;">A reservation has been ${isCancellation ? 'cancelled' : 'modified'} by the customer:</p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
              ...
              <tr>
                ...
                <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.05); color: #8b949e; font-size: 13px;">Guest</td>

                <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-weight: 600; text-align: right; color: #ffffff;">${params.guestName} (${params.guestEmail})</td>

              </tr>

              <tr>

                <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.05); color: #8b949e; font-size: 13px;">Date</td>

                <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-weight: 600; text-align: right; color: #ffffff;">${params.date}</td>

              </tr>

              <tr>

                <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.05); color: #8b949e; font-size: 13px;">Time</td>

                <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-weight: 600; text-align: right; color: #ffffff;">${params.time}</td>

              </tr>

              <tr>

                <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.05); color: #8b949e; font-size: 13px;">Party Size</td>

                <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.05); font-weight: 600; text-align: right; color: #ffffff;">${params.partySize} guests</td>

              </tr>

              <tr>

                <td style="padding: 8px 0; color: #8b949e; font-size: 13px;">Confirmation #</td>

                <td style="padding: 8px 0; font-weight: 600; text-align: right; color: #4a9e6b;">${params.confirmationId.substring(0, 8).toUpperCase()}</td>
            ...
            <div style="margin-top: 16px; padding: 12px; background-color: rgba(201, 156, 99, 0.1); border-radius: 8px;">

              <p style="margin: 0; font-size: 13px; color: #C99C63; font-weight: 600;">Reason:</p>

              <p style="margin: 4px 0 0 0; font-size: 13px; color: #c9d1d9;">${params.reason}</p>
      ...
      text: `Hi ${params.adminName}, a reservation has been ${isCancellation ? 'cancelled' : 'modified'} by ${params.guestName} (${params.guestEmail}) for ${params.date} at ${params.time} (${params.partySize} guests). Confirmation #${params.confirmationId.substring(0, 8).toUpperCase()}.${params.reason ? ` Reason: ${params.reason}` : ''}`,
      ...
      html: `
        ...
        <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #0B1517; color: #ffffff; padding: 40px; border-radius: 16px;">
          ...
          <div style="text-align: center; margin-bottom: 32px;">
            ...
            <h1 style="font-size: 24px; font-weight: 700; margin: 0 0 8px 0; color: #ffffff;">Reservation Update</h1>

          </div>

          <div style="background-color: #101A1C; border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 24px;">

            <p style="color: #e6edf3;">Hi ${params.guestName},</p>
      ...
      html: `
        ...
        <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #0B1517; color: #ffffff; padding: 40px; border-radius: 16px;">
          ...
          <div style="background-color: #101A1C; border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 24px; margin-bottom: 24px;">
            ...
            <p style="color: #e6edf3;">You requested a password reset. Click the button below to set a new password:</p>
