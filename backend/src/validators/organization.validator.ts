...
export const updateOrganizationSchema = z.object({
  ...
  widgetHeading: z.string().max(1000).optional(),
  widgetCtaText: z.string().max(1000).optional(),
  staffIpLoginEnabled: z.boolean().optional(),
  staffTrustedIps: z.string().max(2000).optional(),
